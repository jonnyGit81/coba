...
var file_books_proto_rawDesc = []byte{
	...
	0x28, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x62, 0x06, 0x70,
...
func (c *booksClient) ValidateBooks(ctx context.Context, opts ...grpc.CallOption) (Books_ValidateBooksClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Books_serviceDesc.Streams[0], "/books.Books/ValidateBooks", opts...)
	if err != nil {
		return nil, err
	}
